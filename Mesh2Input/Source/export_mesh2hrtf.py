...
class ExportMesh2HRTF(bpy.types.Operator, ExportHelper):
    ...
    ear = EnumProperty(
            ...
            items=[('Left ear','left','Left ear'),('Right ear','right','Right ear'),('Both ears','both','Both ears'),('None','none','None')],
            default='Both ears',
            )
    evaluationGrid1 = EnumProperty(
            name = "Ev.Grid 1",
            description="Selected evaluation grid",
            items=[('21_NF','NF','NF HYPER (N=46)'),('22_FF','FF','FF HYPER (N=46)'),('3_ARI','ARI','Same as acoustical ARI HRTF measurement (1550)'),('4_Low_ICO','Low ICO','Low spatial resolution (ICO ~2000)'),('4_Low_UV','Low UV','Low spatial resolution (UV ~5000)'),('5_High_ICO','High ICO','High spatial resolution (2°x2°)'),('5_High_UV','High UV','High spatial resolution (2°x2°)'),('7_SPlane','SPlane','Sagittal plane (???)'),('8_HPlane','HPlane','Horizontal plane (???)'),('9_FPlane','FPlane','Frontal plane (???)'),('User','User','User defined evaluation grid'),('None','None','None')],
            default='3_ARI',
            )
    evaluationGrid2 = EnumProperty(
            name = "Ev.Grid 2",
            description="Selected evaluation grid",
            items=[('21_NF','NF','NF HYPER (N=46)'),('22_FF','FF','FF HYPER (N=46)'),('3_ARI','ARI','Same as acoustical ARI HRTF measurement (1550)'),('4_Low_ICO','Low ICO','Low spatial resolution (ICO ~2000)'),('4_Low_UV','Low UV','Low spatial resolution (UV ~5000)'),('5_High_ICO','High ICO','High spatial resolution (2°x2°)'),('5_High_UV','High UV','High spatial resolution (2°x2°)'),('7_SPlane','SPlane','Sagittal plane (???)'),('8_HPlane','HPlane','Horizontal plane (???)'),('9_FPlane','FPlane','Frontal plane (???)'),('None','None','None')],
            default='None',
            )
    ...
    method = EnumProperty(
            ...
            items=[('0','BEM','Traditional BEM'),('1','SL-FMM BEM','Singlelevel fast-multipole method'),('4','ML-FMM BEM','Multilevel fast-multipole method')],
            default='4',
            )
